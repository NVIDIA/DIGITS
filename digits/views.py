...
@app.route('/digits/index.json', methods=['GET'])
...
@app.route('/digits/jobs/<job_id>', methods=['GET'])
@autodoc('jobs')
def show_job(job_id):
    """
...
@app.route('/digits/jobs/<job_id>', methods=['PUT'])
@autodoc('jobs')
def edit_job(job_id):
    """
...
@app.route('/digits/datasets/<job_id>/status', methods=['GET'])
@app.route('/digits/models/<job_id>/status', methods=['GET'])
@app.route('/digits/jobs/<job_id>/status', methods=['GET'])
@autodoc('jobs')
...
@app.route('/digits/datasets/<job_id>', methods=['DELETE'])
@app.route('/digits/models/<job_id>', methods=['DELETE'])
@app.route('/digits/jobs/<job_id>', methods=['DELETE'])
@autodoc('jobs')
...
@app.route('/digits/datasets/<job_id>/abort', methods=['POST'])
@app.route('/digits/models/<job_id>/abort', methods=['POST'])
@app.route('/digits/jobs/<job_id>/abort', methods=['POST'])
@autodoc('jobs')
...
@app.route('/digits/files/<path:path>', methods=['GET'])
@autodoc('util')
def serve_file(path):
    """
